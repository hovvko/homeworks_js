...
//     document.write(`<div>`)
//     document.write(`${simpson.name} - ${simpson.surname} - ${simpson.age} - ${simpson.age} - ${simpson.info} - <img src="${simpson.photo}" alt="">` )
//     document.write(`</div>`)
// }
...
//     document.write(`<h3 class="product_title"> ${product.title} Price: ${product.price} </h3>`)
